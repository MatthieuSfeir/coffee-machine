package fr.imt.coffee_storage;

import fr.imt.coffee_storage.container.Container;
import fr.imt.coffee_storage.container.Cup;
import fr.imt.coffee_storage.container.Mug;
import fr.imt.coffee_storage.exception.ExceptionContainerCreation;
...
public class FabricCupboardContainer {
    ...
    public Container getContainer(String typeContainer, double capacity) throws ExceptionContainerCreation {
        if (typeContainer.equals("mug"))
            ...
            throw new ExceptionContainerCreation("storage.cupboard.container.Container not available in the storage cupboard : " + typeContainer);
    }
}
